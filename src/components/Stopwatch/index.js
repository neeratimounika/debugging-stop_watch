...
class Stopwatch extends Component {
  ...
  componentWillUnmount() {
    //Fix:2 When the setInterval method is used, it is best practice to use clearInterval method to clear the scheduler
    clearInterval(this.timeInterval)
  }

  onResetTimer = () => {
    //Fix:3 class variables should be accessing using the 'this'
    clearInterval(this.timeInterval)
